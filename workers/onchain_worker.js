...
// các bộ lọc giảm số dòng
const FILTER_EXCH_ONLY = (process.env.ONCHAIN_FILTER_EXCHANGES_ONLY || "true") === "true";
const MIN_USD = Number(process.env.ONCHAIN_MIN_USD || 1000);
const IGNORE_SELF = (process.env.ONCHAIN_IGNORE_SELF_TRANSFERS || "true") === "true";
const MAX_ROWS_PER_RUN = Number(process.env.ONCHAIN_MAX_ROWS_PER_RUN || 8000);
